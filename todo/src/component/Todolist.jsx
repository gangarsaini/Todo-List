...
return (
      ...
      <button className='text-white bg-black border-none font-bold w-37.5  rounded-[0px_4px_4px_0px] mx-auto cursor-pointer' onClick={()=>addList()} > {editdata ? "Update Task": "Add"} </button>
